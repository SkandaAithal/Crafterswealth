  ...
  if (productsLoading) {
    return (
      <SwiperComponent
        ...
        breakpoints={{
          320: { slidesPerView: 1.35, spaceBetween: 0 },
                  ...
                  <div className="grid place-content-center gap-3">
                    ...
                    <div className="text-sm">
                      ...
                      <span
                        ...
                        className="cursor-pointer text-primary-blue w-fit mx-auto font-semibold flex gap-1 items-center justify-center mb-4"
                      >
                        Read more <FaArrowRightLong />
                      </span>
                    </div>
